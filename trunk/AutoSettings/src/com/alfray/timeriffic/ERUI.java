...
public class ERUI extends EHA {
    ...
    public static final String EXTRA_IS_EXCEPTION =
        ERUI.class.getPackage().getName() + "_isException";
    ...
    private void setupJavaScript(final WebView wv) {
        ...
        // TODO get numbers
        int num_ex = EH.getNumExceptionsInLog(this);
        int num_act = AS.getNumActionsInLog(this);
    ...
    private class ReportGenerator implements Runnable {
        ...
        public void run() {
            ...
            Context c = ERUI.this.getApplicationContext();
            PV pv = new PV(c);
        ...
        private void addLastExceptions(StringBuilder sb, PV prefs) {
            sb.append("\n## Recent Exceptions ##\n\n");
        ...
        private void addLastActions(StringBuilder sb, PV prefs) {
            sb.append("\n## Recent Actions ##\n\n");
